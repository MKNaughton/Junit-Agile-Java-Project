...
public class BankingApp {
    ...
    //New helper method to check if account exists
    public boolean accountExists(String accountHolder) {
    	//if findAccount returns null it does not exist if it does not return null it exists
    	return findAccount(accountHolder) !=null;
    }
    ...
    //check if account with name  exists in bank - makes visable to Bankingapp for look up
